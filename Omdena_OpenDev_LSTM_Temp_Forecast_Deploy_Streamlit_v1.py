...
def Forecasting(df_initial):
    ...
    df_initial = df_initial.sort_values(by = ['school_name', 'Date/Time EAT'], ascending = [True, True],ignore_index=True)
    df_initial.rename(columns={"Date/Time EAT": "Date"}, inplace=True)
